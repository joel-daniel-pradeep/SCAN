  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-start min-h-screen text-white pt-24">
        <h1 className="text-4xl font-bold mb-8">Caregiver/Senior Login</h1>
        ...
        <div className="mt-4 text-center">
          <p className="text-white">
            ...
            <Link to="/register/caregivers-senior" className="text-blue-400 underline">
              Register here
            </Link>
          </p>
        </div>
...
export default CaregiverSeniorLogin;
